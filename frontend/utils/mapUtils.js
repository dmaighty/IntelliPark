...
export const CAR_CENTER_OFFSET = -0.0015;
export const USER_CENTER_OFFSET = -0.0015;

export const USER_VIEW_LAT_DELTA = FOCUSED_LAT_DELTA;
export const USER_VIEW_LNG_DELTA = FOCUSED_LNG_DELTA;
